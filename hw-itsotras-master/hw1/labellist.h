...
private:
    ...
    int findToken(const MsgToken& token, const LabelType& label) const; //gets the index of the node the MsgToken is pointing to in the all list
...
private:
    ...
    MsgNode* tail; //tail pointer the last msg in the all list
};
